    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="pt-32 pb-20 px-6 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-5xl md:text-6xl font-bold font-serif leading-tight text-balance mb-6">
            Premium Photography & Studio Solutions
          </h1>
          <p className="text-lg text-muted-foreground leading-relaxed max-w-3xl mx-auto">
            From professional photography sessions to state-of-the-art studio rentals, we provide everything you need to bring your creative vision to life.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold font-serif mb-4 text-balance text-gold">
              Photography Services
            </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {photographyServices.map((service, index) => (
              ...
              >
                <div>
                  <h3 className="text-xl font-serif font-bold text-foreground mb-2 group-hover:text-gold transition-colors">
                    {service.title}
                  </h3>
      ...
      <section className="py-20 px-6 bg-background">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Access our fully equipped, professional studio for your creative projects. Flexible rental options for photographers, videographers, and creatives.
            </p>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-4xl md:text-5xl font-bold font-serif mb-6 text-balance">
                Fully Equipped Professional Space
              </h2>
              <p className="text-lg text-primary-foreground/95 leading-relaxed mb-8">
                Our studio features state-of-the-art equipment and professional amenities designed for photographers, videographers, and creative professionals.
              </p>
